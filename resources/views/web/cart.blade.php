                        ...
                        <div class="card-body p-3">
                            @forelse ($cart->items as $item)
                                <div class="cart-item d-flex align-items-center mb-3 border-bottom pb-3">
                                    <img src="{{ $item->itemable->image_url ?? 'https://via.placeholder.com/80?text=Product' }}" class="img-fluid me-3 rounded" alt="{{ $item->itemable->name }}" style="width: 80px; height: 80px; object-fit: cover;">
